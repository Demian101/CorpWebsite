...
class GoodsCategoryBrand(models.Model):
    ...
    class Meta:
        verbose_name = "宣传品牌"
        verbose_name_plural = verbose_name
        db_table = "goods_goodsbrand"  # 定义该 model 在数据库中的表名称
...
class Goods(models.Model):
    ...
    goods_sn = models.CharField("产品 ID", max_length=50, default="")
    ...
    goods_brief = models.TextField("简短描述", max_length=500)
...
class GoodsImage(models.Model):
    ...
    image = models.ImageField(upload_to="goods/images/", verbose_name="图片", null=True, blank=True)  # 传到 MEDIA_ROOT
    add_time = models.DateTimeField("添加时间", default=datetime.now)
